...
namespace Calificacionesp2.Migrations
{
    ...
    [Migration("20251107173529_FirstMigration")]
            ...
            modelBuilder.Entity("Backend.API.Models.Calificacion", b =>
                {
                    ...
                    b.Property<int>("ClaseAlumnoIdClaseAlumno")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ClaseAlumnoIdClaseAlumno");
            ...
            modelBuilder.Entity("Backend.API.Models.Calificacion", b =>
                {
                    b.HasOne("Backend.API.Models.ClaseAlumno", "ClaseAlumno")
                        ...
                        .HasForeignKey("ClaseAlumnoIdClaseAlumno")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
